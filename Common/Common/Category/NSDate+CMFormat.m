...
- (NSTimeInterval)differTimeIntervalToDate:(NSDate*)date {
    ...
    NSTimeInterval otherTimeInterval = date.timeIntervalSince1970;
    return targetTimeInterval - otherTimeInterval;
}
...
- (NSString *)specialString {
    int iYear = (int)self.year;
    int iMonth = (int)self.month;
    int iDay = (int)self.day;
...
- (NSString*)lunarHolidayString {
    ...
    NSDateComponents *localeComp = [localeCalendar components:unitFlags fromDate:self];
    //农历几月 几日
    NSInteger lMonth = localeComp.month;
    NSInteger lDay = localeComp.day;
    if(lMonth == 1 && lDay == 1)
        return @"春节";
    if(lMonth == 1 && lDay == 15)
        return @"元宵";
...
- (NSString*)solarHolidayString {
   ...
   if(self.month == 1 && self.day == 1)
       return @"元旦";
    if(self.month == 2 && self.day == 14)
        return @"情人节";
    if(self.month == 3 && self.day == 8)
        return @"妇女节";
    if(self.month == 3 && self.day == 12)
        return @"植树节";
    if(self.month == 4 && self.day == 1)
        return @"愚人节";
    if(self.month == 5 && self.day == 1)
        return @"劳动节";
    if(self.month == 5 && self.day == 4)
        return @"青年节";
    if(self.month == 6 && self.day == 1)
        return @"儿童节";
    if(self.month == 7 && self.day == 1)
        return @"建党节";
    if(self.month == 8 && self.day == 1)
        return @"建军节";
    if(self.month == 9 && self.day == 10)
        return @"教师节";
    if(self.month == 10 && self.day == 1)
        return @"国庆节";
    if(self.month == 12 && self.day == 24)
        return @"平安夜";
...
//    comps = [calendar components:NSCalendarUnitWeekOfMonth fromDate:self];
//    NSUInteger weekOfMonth = [comps weekOfMonth];
//    if(self.month == 5 && weekOfMonth == 2 && self.weekday == 7)
//        return @"母亲节";
//    if(self.month == 6 && weekOfMonth == 3 && self.weekday == 7)
//        return @"父亲节";
//    if(self.month == 11 && weekOfMonth == 4 && self.weekday == 4)
//        return @"感恩节";
    return @"";
}
//该天是否为法定节假日 18年的需求都能满足
- (BOOL)isLegalHoliday {
